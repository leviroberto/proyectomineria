...
public class FormGestionarTipoPersonal extends javax.swing.JDialog {
    ...
    private GestionarTipoPersonalServicio gestionarTipoPersonalServicio;
...
//           this.TIPO_USUARIO = tipo;
            ...
            gestionarTipoPersonalServicio = new GestionarTipoPersonalServicio();
...
//            inabilitarBotones(true);
    ...
    private void inicializarTablaColumnas() {
        ...
        tablaTipoPersonal.getColumn(tablaTipoPersonal.getColumnName(0)).setWidth(0);
        tablaTipoPersonal.getColumn(tablaTipoPersonal.getColumnName(0)).setMinWidth(0);
        tablaTipoPersonal.getColumn(tablaTipoPersonal.getColumnName(0)).setMaxWidth(0);
    }
    ...
    public void limpiarTabla() {
        ModeloTabla modelo = (ModeloTabla) tablaTipoPersonal.getModel();
    ...
    private void inicializarTabla() {
        try {
            limpiarTabla();
            gestionarTipoPersonalServicio.mostrarTipoPersonal(1, tablaTipoPersonal);
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        tablaTipoPersonal = new rojerusan.RSTableMetro();
        ...
        tablaTipoPersonal.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaTipoPersonal.setAltoHead(30);
        tablaTipoPersonal.setColorBackgoundHead(new java.awt.Color(65, 94, 255));
        tablaTipoPersonal.setColorFilasForeground1(new java.awt.Color(65, 94, 255));
        tablaTipoPersonal.setColorFilasForeground2(new java.awt.Color(65, 94, 255));
        tablaTipoPersonal.setColorSelBackgound(new java.awt.Color(253, 173, 1));
        tablaTipoPersonal.setComponentPopupMenu(popMenu);
        tablaTipoPersonal.setGrosorBordeFilas(0);
        tablaTipoPersonal.setGrosorBordeHead(0);
        tablaTipoPersonal.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tablaTipoPersonalMousePressed(evt);
            }
        });
        tablaTipoPersonal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tablaTipoPersonalKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tablaTipoPersonalKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tablaTipoPersonalKeyTyped(evt);
            }
        });
        jScrollPane1.setViewportView(tablaTipoPersonal);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(txtBuscarTipoTrabajador, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//    }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            FormDatosTipoPersonal datosTipoPersonal = new FormDatosTipoPersonal(null, true);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            obtenerTipoPersonalSeleccionado();
            FormDatosTipoPersonal tipoTrabajador = new FormDatosTipoPersonal(null, true, tipoTrabajadorSeleccionado);
...
metodoParaEliminar();
    ...
    private void tablaTipoPersonalMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaTipoPersonalMousePressed
        fila = tablaTipoPersonal.getSelectedRow();
        inabilitarBotones(false);
    }//GEN-LAST:event_tablaTipoPersonalMousePressed

    private void tablaTipoPersonalKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaTipoPersonalKeyTyped
        fila = tablaTipoPersonal.getSelectedRow();
        inabilitarBotones(false);
    }//GEN-LAST:event_tablaTipoPersonalKeyTyped

    private void tablaTipoPersonalKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaTipoPersonalKeyReleased
        fila = tablaTipoPersonal.getSelectedRow();
        inabilitarBotones(false);
    }//GEN-LAST:event_tablaTipoPersonalKeyReleased

    private void tablaTipoPersonalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaTipoPersonalKeyPressed
        fila = tablaTipoPersonal.getSelectedRow();
        ...
        inabilitarBotones(false);
    }//GEN-LAST:event_tablaTipoPersonalKeyPressed
    ...
    private void txtBuscarTipoTrabajadorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarTipoTrabajadorKeyReleased
        try {
            ...
            if (texto.equals("")) {
                ...
                limpiarTabla();
                gestionarTipoPersonalServicio.mostrarTipoPersonal(1, tablaTipoPersonal, texto);
            }
    ...
    private void obtenerTipoPersonalSeleccionado() {
        try {
            String codigo = tablaTipoPersonal.getValueAt(fila, 0).toString();
            tipoTrabajadorSeleccionado = gestionarTipoPersonalServicio.buscarTipoPersonalPorCodigo(Integer.parseInt(codigo));
        } catch (Exception e) {
            Mensaje.mostrarErrorSistema(this);
        }
    ...
    private void metodoParaEliminar() {
        try {
            ...
            if (tipoTrabajadorSeleccionado != null) {
                ...
                try {
                    int registros_afectados = gestionarTipoPersonalServicio.eliminarTipoPersonal(tipoTrabajadorSeleccionado);
...
//    }
    ...
    private rojerusan.RSTableMetro tablaTipoPersonal;
...
////
////        try {
////            tipoTrabajadorSeleccionado = gestionarTipoPersonalServicio.buscarTipoPersonalPorCodigo(codigo.trim());
