...
import static SistemaLara.capa1_presentacion.FormGestionarProveedorServicios.TIPO_FACTURA;
 ...
 * @author XGamer
 */
public class FormlistaProvedorServicioFactura extends javax.swing.JDialog {
    ...
    public static int TIPO_NOTA_DEBITO = 7;

    public static int TIPO_CHEQUE = 6;
    public static int TIPO_NOTA_CREDITO = 8;
    private int TIPO_USUARIO;

    public FormlistaProvedorServicioFactura(java.awt.Frame parent, boolean modal, int tipo) {
        super(parent, modal);
        try {
            initComponents();
            BarraDesplzamiento();
    ...
    private void inicializarTablaColumnas() {
        ...
        tabla.agregarColumna(new Columna("TIPO PROVEEDOR", "java.lang.String"));
    ...
    private void inicializarTabla() {
        try {
            limpiarTabla();
            gestionarProveedorServicioServicio.mostrarPorFacturacion(1, tableProveedorServicio);
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("LISTA DE REGISTRO PROVEEDOR SERVICIOS POR FACTURACIÓN ");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addComponent(txtBuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 616, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        try {
            ...
            if (texto.equals("")) {
                ...
                limpiarTabla();
                gestionarProveedorServicioServicio.mostrarProveedorLikePorFacturacion(1, tableProveedorServicio, texto);
            }
        } catch (Exception e) {
        }
    ...
    private void obtenerProveedorServicio() {
        ...
        try {
            ...
            if (TIPO_USUARIO == TIPO_FACTURA) {
                ...
                FormRegistroNotaDeDebito.proveedorServicioSeleccionado = proveedorServicioSeleccionado;
                this.dispose();
