 ...
 */
public class FormDatosTipoPersonal extends javax.swing.JDialog {

    GestionarTipoPersonalServicio gestionarTipoPersonalServicio;
    TipoPersonal tipoPersonal;
    private final int ACCION_CREAR = 1;
    private final int ACCION_MODIFICAR = 2;
    private int tipo_accion;
    private int codigoTipoPersonal;
    private Estado estado;
//
//    private Estado estado;

    public FormDatosTipoPersonal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public FormDatosTipoPersonal(java.awt.Frame parent, boolean modal, TipoPersonal tipoPersonal) {
        super(parent, modal);
        initComponents();
        // Animacion.moverParaIzquierda(this);
        this.setLocationRelativeTo(null);
        ...
        llenarCampos(tipoPersonal);
        gestionarTipoPersonalServicio = new GestionarTipoPersonalServicio();
        verificarCamposVacios();
    }

    private void llenarCampos(TipoPersonal tipoPersonal1) {
        codigoTipoPersonal = tipoPersonal1.getCodigo();
        txtDescripcion.setText(tipoPersonal1.getDescripcion());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATOS DEL TIPO PERSONAL");
        ...
        rSLabelImage3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SistemaLara/capa5_imagenes/TipoPersonal.png"))); // NOI18N
        ...
        jPanel3.add(txtDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 200, 60));
        jPanel3.add(lblTipoPersonal, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 200, 10));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 41, 302, 96));
        ...
        jPanel4.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 50, 140, 46));
        ...
        jPanel4.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 140, 46));

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(3, 97, 320, 106));
    ...
    private boolean verificarCamposVacios() {
        int contadr = 0, aux = 0;
        contadr = Verificador.verificadorCampos(txtDescripcion,lblTipoPersonal,"Tipo Personal");
        aux = contadr + aux;
        return aux == 1;
    }
        ...
        if (verificarCamposVacios()) {
            ...
            if (tipo_accion == ACCION_CREAR) {
                try {
                    ...
                    estado = new Estado();
                    estado.setCodigo(1);
                    tipoPersonal.setDescripcion(txtDescripcion.getText());
                    tipoPersonal.setEstado(estado);
                    registros_afectados = gestionarTipoPersonalServicio.guardarTipoPersonal(tipoPersonal);

                    if (registros_afectados == 1) {
                        Mensaje.mostrarAfirmacionDeCreacion(this);
                        DesktopNotify.showDesktopMessage("FiveCod Software", "Usted Acaba Crear una Nueva Tipo Personal", DesktopNotify.SUCCESS);
                        this.dispose();
                ...
                try {
                    estado = new Estado();
                    estado.setCodigo(1);
                    this.tipoPersonal.setDescripcion(txtDescripcion.getText());
                    this.tipoPersonal.setEstado(estado);
                    registros_afectados = gestionarTipoPersonalServicio.modificarTipoPersonal(this.tipoPersonal);
                    if (registros_afectados == 1) {
                        Mensaje.mostrarAfirmacionDeActualizacion(this);
                        DesktopNotify.showDesktopMessage("FiveCod Software", "Usted Acaba Modificar Tipo Personal", DesktopNotify.INPUT_REQUEST);
                        this.dispose();
                    } else if (registros_afectados == 0) {
