...
public class FCMaterialComboBox<T> extends JComboBox<T> {
    ...
    public void paint(Graphics g) {
        ...
        g.setFont(myFont);
        g.setColor(getSelectedItem() == null ? FCUtilsMaterial.applyAlphaMask(getForeground(), HINT_OPACITY_MASK) : getForeground());
    ...
    public static class FieldRenderer<T> extends JComponent implements ListCellRenderer<T> {
        ...
        private final FCMaterialComboBox comboBox;
        private String text;
        private boolean mouseOver = false;
        private boolean selected = false;

        public FieldRenderer(FCMaterialComboBox comboBox) {
        ...
        public void paint(Graphics g) {
            ...
            if (mouseOver) {
                g.setColor(FCUtilsMaterial.isDark(comboBox.getBackground()) ? FCUtilsMaterial.brighten(comboBox.getBackground()) : FCUtilsMaterial.darken(comboBox.getBackground()));
            } else {
    ...
    /*public static void main(String[] args) {
        ...
        FCMaterialComboBox comboBox = new FCMaterialComboBox();
        ...
        FCMaterialTextField textField = new FCMaterialTextField();
