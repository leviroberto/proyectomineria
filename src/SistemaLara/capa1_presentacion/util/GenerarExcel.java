...
//import motorepuestos.capa4_persistencia.Almacen.GestorJDBCMySQL;

public class GenerarExcel {

    DatosDeTabla dataProvider;
    GestorJDBC gestorJDBC;

    public GenerarExcel() {
        gestorJDBC = new GestorJDBCMySQL();
        dataProvider = new DatosDeTabla(gestorJDBC);
     ...
     * @return
     */
    public HSSFWorkbook generateExcel() throws Exception {
        ...
        List<String> headerValues = DatosDeTabla.getTableHeaders();
        ...
        List<List<String>> contentRowValues = dataProvider.getTableContent(40);
