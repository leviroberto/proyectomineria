 ...
 */
public class FormGestionarFacturaElectronica extends javax.swing.JDialog {

    private GestionarFacturaElectronicaServicio gestionarFacturaElectronicaServicio;
    ...
    public FormGestionarFacturaElectronica(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        gestionarFacturaElectronicaServicio = new GestionarFacturaElectronicaServicio();
...
//            inicializarTablaColumnas();
        llenarComboItemFacturaElectronica();
...
//        tablaFacturaElectronica.setModel(modeloTabla);
    ...
    private void obtenerDatosParaLista() {
        try {
            ...
            gestionarFacturaElectronicaServicio.mostrarFacturaElectronica(numero, fechaInicio, fechaFin, tablaFacturaElectronica);
            if (numero == 1) {
    ...
    private void llenarComboItemFacturaElectronica() {
        try {
            gestionarFacturaElectronicaServicio.llenarItemTipoFacturaElectronica(1, cboItemFacturaElectronica);
        } catch (Exception e) {
    ...
    private void llenarComboEstadoFacturaElectronica() {
        try {
            ...
            lista = gestionarFacturaElectronicaServicio.llenarEstadoFacturaElectronica(1);
    ...
    private void initComponents() {
        ...
        cboItemFacturaElectronica = new FiveCodMaterilalDesignComboBox.MaterialComboBox<TipoFacturaElectronica>();
        cboEstadoFacturaElectronica = new FiveCodMaterilalDesignComboBox.MaterialComboBox<EstadoFacturaElectronica>();
        ...
        jLabel1.setText("GESTIONAR FACTURA ELECTRONICA ");
        ...
        cboItemFacturaElectronica.setBackground(new java.awt.Color(255, 255, 255));
        cboItemFacturaElectronica.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(65, 94, 255)));
        cboItemFacturaElectronica.setForeground(new java.awt.Color(65, 94, 255));
        cboItemFacturaElectronica.setAccent(new java.awt.Color(65, 94, 255));
        cboItemFacturaElectronica.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboItemFacturaElectronicaActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(cboItemFacturaElectronica, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cboItemFacturaElectronica, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tablaFacturaElectronica.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Seleccione", "Id Factura", "Nro", "Total", "Fecha", "Id Electronico"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Boolean.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.String.class
            };
    ...
    private void btnEnviarCorreoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarCorreoActionPerformed
        try {
            ...
            CorreoFactura correoFactura = gestionarFacturaElectronicaServicio.buscarParaCorreo(codigo);
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if (listaSeleccionado.size() > 0) {
            for (int i = 0; i < listaSeleccionado.size(); i++) {
                boolean resultado = generarFactura(listaSeleccionado.get(i).getCodigo(), IniciarSesion.getUsuario().getEmpresa().getEmpresabd());
    ...
    private void btnDarDeBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDarDeBajaActionPerformed
        ...
        if (listaSeleccionado.size() > 0) {
            ...
            if (listaIdFactura.length() > 0) {
                boolean estadoResultado = darDeBaja(listaIdFactura, listaMensaje, IniciarSesion.getUsuario().getEmpresa().getEmpresabd(), IniciarSesion.getUsuario().getEmpresa().getCodigo());
                if (estadoResultado) {
...
//            cboxSeleccionarTodos.setSelected(false);
    ...
    private void cboItemFacturaElectronicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboItemFacturaElectronicaActionPerformed

    }//GEN-LAST:event_cboItemFacturaElectronicaActionPerformed
    ...
    private FiveCodMaterilalDesignComboBox.MaterialComboBox<TipoFacturaElectronica> cboItemFacturaElectronica;
    ...
    private static Boolean generarFactura(java.lang.Integer idFactura, java.lang.String empresa) {
        try {
            org.tempuri.Service1 service = new org.tempuri.Service1();
            org.tempuri.IService1 port = service.getBasicHttpBindingIService1();
            return port.generarFactura(idFactura, empresa);
        } catch (Exception e) {
            DesktopNotify.showDesktopMessage("FiveCod Software", "Error al tratar de cominicarse con la sunat revise la conexion ", DesktopNotify.ERROR);
            return false;
        }

    }

    private static Boolean darDeBaja(java.lang.String listaIdFactura, java.lang.String listaMotivoBaj, java.lang.String empresa, java.lang.Integer idEmpresa) {
        boolean respuesta = false;
        try {
            org.tempuri.Service1 service = new org.tempuri.Service1();
            org.tempuri.IService1 port = service.getBasicHttpBindingIService1();
            respuesta = port.darDeBaja(listaIdFactura, listaMotivoBaj, empresa, idEmpresa);
        } catch (Exception e) {
