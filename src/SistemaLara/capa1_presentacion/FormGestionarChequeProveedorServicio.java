 ...
 */
public class FormGestionarChequeProveedorServicio extends javax.swing.JDialog {

    private GestionarChequeProveedorServicio gestionarChequeServicio;
    public static ProveedorServicio proveedorServicioSeleccionado;

    public PagoTransporte pagoTransporteSeleccionado;
    ...
    private static ChequeProveedor chequeSeleccionado;
    ...
    public FormGestionarChequeProveedorServicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            BarraDesplzamiento();
...
//            this.TIPO_USUARIO = tipo;
            ...
            gestionarChequeServicio = new GestionarChequeProveedorServicio();
    ...
    public FormGestionarChequeProveedorServicio(java.awt.Frame parent, boolean modal, ChequeProveedor cheque) {
        super(parent, modal);
        try {
...
//            verificarPreview(estado_preview);
    ...
    public void llenarCamposTexto(ChequeProveedor cheque) {
        try {
            if (String.valueOf(cheque.getCodigo()) != null) {
                txtCodigo.setText("" + cheque.getCodigo());
            }
            txtProveedorEntrante.setText(cheque.getProveedorServicio().getRazonSocial());
            ...
            proveedorServicioSeleccionado = cheque.getProveedorServicio();
            mostrarCalculos();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GESTIONAR DATOS DE CHEQUE POR PROVEEDOR SERVICIO ");
    ...
    private void txtProveedorEntranteKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtProveedorEntranteKeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            txtProveedorEntrante.setLabel("PARA");
            FormGestionarProveedorServicios a = new FormGestionarProveedorServicios(null, true, FormGestionarProveedorServicios.TIPO_CHEQUE);
            a.setVisible(true);
            if (proveedorServicioSeleccionado != null) {
                txtProveedorEntrante.setText(proveedorServicioSeleccionado.getRazonSocial());
                txtEntregadoA.setText(proveedorServicioSeleccionado.getRazonSocial());
                txtEntregadoA.requestFocus();
            }

        } else if (proveedorServicioSeleccionado != null) {
            txtProveedorEntrante.setText(proveedorServicioSeleccionado.getRazonSocial());
            txtProveedorEntrante.setLabel("PARA");
...
//        }
    ...
    public void guardarCheque() {
        ...
        chequeSeleccionado = new ChequeProveedor();
        if (verificarCamposVacios()) {

            chequeSeleccionado.setProveedorServicio(proveedorServicioSeleccionado);
            ...
            if (dataEmision.getDatoFecha() != null) {
                Date fechaEmision = dataEmision.getDatoFecha();
                chequeSeleccionado.setFechaEmision(format.format(fechaEmision).toString());
            }
        ...
        try {
            ...
            if (chequeSeleccionado != null) {
                ...
                try {
                    ...
                    if (registros_afectados == 1) {
                        DesktopNotify.showDesktopMessage("FiveCod Software", "Usted Acaba de eliminar el cheque de pago", 7);
