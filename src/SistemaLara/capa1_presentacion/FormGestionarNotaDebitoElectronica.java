 ...
 */
public class FormGestionarNotaDebitoElectronica extends javax.swing.JDialog {
    ...
    public FormGestionarNotaDebitoElectronica(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
...
//        tablaFacturaElectronica.setModel(modeloTabla);
    ...
    private void obtenerDatosParaLista() {
        try {
            ...
            gestionarNotaDebitoServicio.mostrarNotaDebitpElectronico(numero, fechaInicio, fechaFin, tablaFacturaElectronica);
            if (numero == 1) {
    ...
    private void llenarComboEstadoFacturaElectronica() {
        try {
            ...
            lista = gestionarNotaDebitoServicio.llenarEstadoFacturaElectronica(1);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GESTIONAR NOTA DEBITO ELECTRONICA ");
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if (listaSeleccionado.size() > 0) {
            for (int i = 0; i < listaSeleccionado.size(); i++) {
                ...
                boolean resultado = generarNotaDebito(listaSeleccionado.get(i).getCodigo(), IniciarSesion.getUsuario().getEmpresa().getEmpresabd());
    ...
    private void btnDarDeBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDarDeBajaActionPerformed
        ...
        if (listaSeleccionado.size() > 0) {
            ...
            if (listaIdFactura.length() > 0) {
                boolean estadoResultado = darDeBajaNotaDebito(listaIdFactura, listaMensaje, IniciarSesion.getUsuario().getEmpresa().getEmpresabd(), IniciarSesion.getUsuario().getEmpresa().getCodigo());
                if (estadoResultado) {
...
//            cboxSeleccionarTodos.setSelected(false);
    ...
    private void btnEnviarCorreoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarCorreoActionPerformed
        try {
            ...
            CorreoFactura correoFactura = gestionarNotaDebitoServicio.buscarParaCorreo(codigo);
    ...
    private static Boolean generarNotaDebito(java.lang.Integer idNotaDebito, java.lang.String empresa) {

        boolean respuesta = false;
        try {
            org.tempuri.Service1 service = new org.tempuri.Service1();
            org.tempuri.IService1 port = service.getBasicHttpBindingIService1();
            respuesta = port.generarNotaDebito(idNotaDebito, empresa);
        } catch (Exception e) {
    ...
    private static Boolean darDeBajaNotaDebito(java.lang.String listaIdFactura, java.lang.String listaMotivoBaj, java.lang.String empresa, java.lang.Integer idEmpresa) {
        boolean respuesta = false;
        try {

            org.tempuri.Service1 service = new org.tempuri.Service1();
            org.tempuri.IService1 port = service.getBasicHttpBindingIService1();
            respuesta = port.darDeBajaNotaDebito(listaIdFactura, listaMotivoBaj, empresa, idEmpresa);
