 ...
 */
public class FormGestionarNotaCredito extends javax.swing.JDialog {

    private GestionarNotaCreditoServicio gestionarNotaCreditoServicio;
    public static NotaCredito notaCreditoSelecionado;
    public static int TIPO_ADMINISTRADOR = 1;
    public static int TIPO_LIQUIDACION = 2;
    private int TIPO_USUARIO;

    public FormGestionarNotaCredito(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            BarraDesplzamiento();
...
//            this.TIPO_USUARIO = tipo;
            notaCreditoSelecionado = new NotaCredito();
...
//        this.setBounds(FormMenu.posicion_x_form_menu_axuliar, this.getY(), FormMenu.ancho_para_formularios, this.getHeight());
    ...
    private void inicializarTablaColumnas() {
        ...
        tabla.agregarColumna(new Columna("N° NOTA CREDITO", "java.lang.String"));
        tabla.agregarColumna(new Columna("N° FACTURA", "java.lang.String"));
        tabla.agregarColumna(new Columna("PROVEEDOR", "java.lang.String"));
        tabla.agregarColumna(new Columna("FECHA EMISIÓN", "java.lang.String"));
        tabla.agregarColumna(new Columna("FECHA COMPROBANTE", "java.lang.String"));
    ...
    private void inicializarTabla() {
        try {
            limpiarTabla();
            gestionarNotaCreditoServicio.mostrarNotaCreditos(1, tableFactura);
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GESTIONAR DATOS NOTA CREDITO");
...
//        }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            FormRegistroNotaCredito datosTipoPersonal = new FormRegistroNotaCredito(null, true);
            datosTipoPersonal.setVisible(true);
            inicializarTabla();
            notaCreditoSelecionado = null;
            inabilitarBotones(true);
 ...
 txtBuscar.setText(txtBuscar.getText().toUpperCase());
            if (!txtBuscar.getText().equals("")) {
                ...
                limpiarTabla();
                gestionarNotaCreditoServicio.mostrarFacturas(1, tableFactura, txtBuscar.getText());
            }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            ...
            FormRegistroNotaCredito factura = new FormRegistroNotaCredito(null, true, notaCreditoSelecionado);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            obtenerFacturaSeleccionado();
            if (notaCreditoSelecionado != null) {
                if (!Mensaje.mostrarPreguntaDeEliminacion(this)) {
                    return;
                }

                try {
                    int registros_afectados = gestionarNotaCreditoServicio.eliminarNotaCredito(notaCreditoSelecionado);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        try {
            ...
            if (texto.equals("")) {
                ...
                limpiarTabla();
                gestionarNotaCreditoServicio.mostrarFacturas(1, tableFactura, texto);
            }
    ...
    private void obtenerFacturaSeleccionado() {
        try {
            ...
            notaCreditoSelecionado = gestionarNotaCreditoServicio.buscarNotaCreditoPorCodigo(Integer.parseInt(codigo));
        } catch (Exception e) {
            Mensaje.mostrarErrorSistema(this);
        }
