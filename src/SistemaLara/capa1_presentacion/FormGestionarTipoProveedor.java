 ...
 */
public class FormGestionarTipoProveedor extends javax.swing.JDialog {

    private GestionarTipoProveedorServicio gestionarTipoProveedorServicio;
    public static TipoProveedor tipoProveedorSeleccionado;
    public static int TIPO_ADMINISTRADOR = 2;
    public static int TIPO_TRABAJADOR = 1;
    private int TIPO_USUARIO;

    public FormGestionarTipoProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            popMenu.add(pnlMenu);
...
//            obtenerDatosTabla();
    ...
    private void inicializarTablaColumnas() {
        ...
        tablaTipoProveedor.setModel(modeloTabla);
        tablaTipoProveedor.getColumn(tablaTipoProveedor.getColumnName(0)).setWidth(0);
        tablaTipoProveedor.getColumn(tablaTipoProveedor.getColumnName(0)).setMinWidth(0);
        tablaTipoProveedor.getColumn(tablaTipoProveedor.getColumnName(0)).setMaxWidth(0);
    }

    public void limpiarTabla() {
        ModeloTabla modelo = (ModeloTabla) tablaTipoProveedor.getModel();
    ...
    private void inicializarTabla() {
        try {
            limpiarTabla();
            gestionarTipoProveedorServicio.mostrarTipoProveedores(1, tablaTipoProveedor);
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        tablaTipoProveedor = new rojerusan.RSTableMetro();
        ...
        jLabel1.setText("GESTIONAR DATOS DE TIPO PROVEEDOR ");
        ...
        tablaTipoProveedor.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaTipoProveedor.setAltoHead(30);
        tablaTipoProveedor.setColorBackgoundHead(new java.awt.Color(65, 94, 255));
        tablaTipoProveedor.setColorFilasForeground1(new java.awt.Color(65, 94, 255));
        tablaTipoProveedor.setColorFilasForeground2(new java.awt.Color(65, 94, 255));
        tablaTipoProveedor.setColorSelBackgound(new java.awt.Color(253, 173, 1));
        tablaTipoProveedor.setComponentPopupMenu(popMenu);
        tablaTipoProveedor.setGrosorBordeFilas(0);
        tablaTipoProveedor.setGrosorBordeHead(0);
        tablaTipoProveedor.setRowHeight(20);
        tablaTipoProveedor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tablaTipoProveedorMousePressed(evt);
            }
        });
        tablaTipoProveedor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tablaTipoProveedorKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tablaTipoProveedorKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tablaTipoProveedorKeyTyped(evt);
            }
        });
        jScrollPane3.setViewportView(tablaTipoProveedor);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(txtBuscarTipoTrabajador, javax.swing.GroupLayout.PREFERRED_SIZE, 269, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        listaTipoProveedor = gestionarTipoProveedorServicio.mostrarTipoProveedors(TipoProveedor.ESTADO_ACTIVO);
//        obtenerDatosTabla();
    }
    ...
    int fila;
    private void tablaTipoProveedorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaTipoProveedorMousePressed
        fila = tablaTipoProveedor.getSelectedRow();
        inabilitarBotones(false);
    }//GEN-LAST:event_tablaTipoProveedorMousePressed

    private void tablaTipoProveedorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaTipoProveedorKeyReleased
        fila = tablaTipoProveedor.getSelectedRow();
        inabilitarBotones(false);
    }//GEN-LAST:event_tablaTipoProveedorKeyReleased

    private void tablaTipoProveedorKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaTipoProveedorKeyTyped
//        try {
...
//        }
    ...
    }//GEN-LAST:event_tablaTipoProveedorKeyTyped

    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try {
            FormDatosTipoProveedor datosTipoPersonal = new FormDatosTipoProveedor(null, true);
...
//        try {
//            if (!txtBuscarTipoProveedor.getText().equals("")) {
//                listaTipoProveedor = null;
//                listaTipoProveedor = gestionarTipoProveedorServicio.buscarTipoProveedorPorNombre(txtBuscarTipoProveedor.getText().trim());
//                obtenerDatosTabla();
//            } else {
//                listaTipoProveedor = null;
//                obtenerDatosParaTabla();
//                txtBuscarTipoProveedor.setText("");
//            }
//
//        } catch (Exception ex) {
...
//        }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            obtenerTipoProveedorSeleccionado();
            FormDatosTipoProveedor tipoProveedor = new FormDatosTipoProveedor(null, true, tipoProveedorSeleccionado);
            tipoProveedor.setVisible(true);
            inicializarTabla();
            tipoProveedorSeleccionado = null;
            inabilitarBotones(true);
        } catch (Exception e) {
    ...
    private void txtBuscarTipoTrabajadorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarTipoTrabajadorKeyReleased
        try {
            ...
            if (texto.equals("")) {
                ...
                limpiarTabla();
                gestionarTipoProveedorServicio.mostrarTipoProveedores(1, tablaTipoProveedor, texto);
            }
    ...
    private void tablaTipoProveedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablaTipoProveedorKeyPressed
        fila = tablaTipoProveedor.getSelectedRow();

        if (evt.getKeyChar() == KeyEvent.VK_DELETE) {
            metodoParaEliminar();
        }
    }//GEN-LAST:event_tablaTipoProveedorKeyPressed

    private void obtenerTipoProveedorSeleccionado() {
        try {
            String codigo = tablaTipoProveedor.getValueAt(fila, 0).toString();
            tipoProveedorSeleccionado = gestionarTipoProveedorServicio.buscarTipoProveedorPorCodigo(Integer.parseInt(codigo));
        } catch (Exception e) {
            Mensaje.mostrarErrorSistema(this);
        }
...
//        Fila filaTabla;
//        try {
//            ModeloTabla modeloTabla = (ModeloTabla) tablaTipoProveedors.getModel();
//            modeloTabla.eliminarTotalFilas();
//            if (listaTipoProveedor.size() == 0) {
...
//                    filaTabla = new Fila();
//                    filaTabla.agregarValorCelda(tipoProveedor.getCodigo());
//                    filaTabla.agregarValorCelda(tipoProveedor.getDescripcion());
...
//    }
    ...
    private rojerusan.RSTableMetro tablaTipoProveedor;
    ...
    private void metodoParaEliminar() {
        try {
            ...
            if (tipoProveedorSeleccionado != null) {
                ...
                try {
                    int registros_afectados = gestionarTipoProveedorServicio.eliminarTipoProveedor(tipoProveedorSeleccionado);
...
//    private void obtenerTipoProveedor() {
////        String codigo = tablaTipoProveedors.getValueAt(fila, 0).toString();
////
////        try {
////            tipoProveedorSeleccionado = gestionarTipoProveedorServicio.buscarTipoProveedorPorCodigo(codigo.trim());
////            if (TIPO_USUARIO == TIPO_TRABAJADOR) {
////                tipoProveedorSeleccionado = tipoProveedorSeleccionado;
////                this.dispose();
////            } else {
////                inabilitarBotones(false);
////            }
