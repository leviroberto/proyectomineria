 ...
 */
public class FacturaElectronicaDAOMySQL {

    private final GestorJDBC gestorJDBC;

    public FacturaElectronicaDAOMySQL(GestorJDBC gestorJDBC) {
    ...
    public int agregar(Factura factura) throws SQLException {
        ...
        try {
            ...
            throw new SQLException("No se pudo registrar la Factura Electronica.\n"
    ...
    public void mostrarFacturaElectronica(int numero, String fechaInicio, String fechaFin, JTable tablaFacturaElectronica) throws SQLException {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                registros[5] = resultado.getInt("FacturaElectronica_Id");
    ...
    public CorreoFactura buscarParaCorreo(String codigo) throws SQLException {
        ...
        ProveedorServicioDAOMySQL proveedorServicioDAOMySQL;
        try {
            CallableStatement prcProcedimientoAlmacenado = gestorJDBC.prepareCall("FacturaElectronico_BuscarParaCorreo_sp(?)");
            ...
            if (resultado.next()) {
                ...
                proveedorServicioDAOMySQL = new ProveedorServicioDAOMySQL(gestorJDBC);
                facturaElectronica.setId(resultado.getInt("FacturaElectronica_Id"));
                facturaElectronica.setRutapdf(resultado.getString("FacturaElectronica_RutaPDF"));
                facturaElectronica.setRutaxml(resultado.getString("FacturaElectronica_RutaXML"));
                facturaElectronica.setCodigoFactura(resultado.getInt("Factura_Id"));
                facturaElectronica.setNumeroFactura(resultado.getString("Factura_Nro"));
    ...
    int modificarRutaPDF(String url, int codigoFactura) throws SQLException {
        try {
            CallableStatement prcProcedimientoAlmacenado = gestorJDBC.prepareCall("FacturaElectronico_ModificarRutaODF_sp(?,?)");
            prcProcedimientoAlmacenado.setInt(1, codigoFactura);
            prcProcedimientoAlmacenado.setString(2, url);
            return prcProcedimientoAlmacenado.executeUpdate();
        } catch (Exception e) {
